...
//TODO: change every "eshkol" with current location and test it at the university!
    ...
    public void onClick2(View v) {
        ...
        LocationDataPoint[] foodPointsList = (LocationDataPoint[]) FoodPoints.entrySet().parallelStream().sorted( (o1, o2) -> {
            Map<LocationDataPoint, Dijkstra<LocationDataPoint>.Three> distMap = dijkstra.getDistance();
            return Double.compare(
                                    distMap.get(o1.getValue()).getWeight(),
                                    distMap.get(o2.getValue()).getWeight());
        }).toArray();
